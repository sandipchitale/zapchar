...
public final class CharSideBar extends JToolBar implements HelpCtx.Provider {
    ...
    public CharSideBar() {
        ...
        closeButton = new JButton(" ",
                new ImageIcon(ImageUtilities.loadImage("org/netbeans/modules/editor/zapchar/resources/close.gif"))); // NOI18N
    ...
    private void doCharOperation(char opChar, int times) {
        ...
        switch (mode) {
            case FROM:
                LineOperations.fromChar(EditorRegistry.lastFocusedComponent(), opChar, matchCaseCheckBox.isSelected(), times);
                break;
            case AFTER:
                LineOperations.afterChar(EditorRegistry.lastFocusedComponent(), opChar, matchCaseCheckBox.isSelected(), times);
                break;
            case UPTO:
                LineOperations.uptoChar(EditorRegistry.lastFocusedComponent(), opChar, matchCaseCheckBox.isSelected(), times);
                break;
            case TO:
                LineOperations.toChar(EditorRegistry.lastFocusedComponent(), opChar, matchCaseCheckBox.isSelected(), times);
                break;
        }
    }
